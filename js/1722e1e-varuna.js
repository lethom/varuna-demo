...
(function(exports) {
  ...
  var render = function (v) {
      return Halogen_HTML_Elements.div_(v.value0.preview);
  };
  var init = new State({
      preview: [  ], 
      queue: Free.value
  ...
  var $$eval = function (v) {
              ...
              return Control_Bind.bind(Control_Monad_Free.freeBind)((function () {
                  if (v1 instanceof Free) {
                      return Control_Bind.bind(Control_Monad_Free.freeBind)(Data_Function.apply(Halogen_Query.modify)(setQueue(Busy.value)))(function () {
                          return Data_Function.apply(function ($47) {
                              return Varuna_Component_Utils.raise(Control_Monad_Aff_Free.affableAff)(Control_Monad_Aff.functorAff)(Halogen_Query.action($47));
                          })(Render.create(v.value0)(v.value1));
                      });
                  };
                  return Data_Function.apply(function ($48) {
                      return Halogen_Query.modify(setQueue($48));
      ...
      if (v instanceof Render) {
          ...
          return Control_Bind.bind(Control_Monad_Free.freeBind)(Data_Function.apply(function ($49) {
              return Control_Monad_Aff_Free.fromAff(Control_Monad_Aff_Free.affableFree(Halogen_Query_HalogenF.affableHalogenF(Control_Monad_Aff_Free.affableAff)))(Control_Monad_Aff.attempt($49));
              ...
              return Control_Bind.bind(Control_Monad_Free.freeBind)((function () {
                  ...
                  throw new Error("Failed pattern match at Varuna.UI.Renderer line 72, column 3 - line 74, column 37: " + [ v1.constructor.name ]);
              })())(function () {
                  return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(v.value2);
              });
          });
      ...
      throw new Error("Failed pattern match at Varuna.UI.Renderer line 63, column 1 - line 68, column 12: " + [ v.constructor.name ]);
  };
  var renderer = Halogen_Component.lifecycleComponent({
      render: render, 
      "eval": $$eval, 
      initializer: Data_Maybe.Nothing.value, 
      finalizer: Data_Maybe.Nothing.value
...
(function(exports) {
  ...
  var renderLanguageSelector = function (current) {
      return function (option) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements_Indexed.input([ Data_Function.apply(Halogen_HTML_Properties_Indexed.checked)(Data_Eq.eq(Varuna_Ogmarkup.eqLang)(current)(option)), Halogen_HTML_Properties_Indexed.inputType(Halogen_HTML_Properties_Indexed.InputRadio.value), Data_Function.apply(function ($45) {
              ...
              throw new Error("Failed pattern match at Varuna.UI.Editor line 56, column 12 - line 58, column 10: " + [ option.constructor.name ]);
          })()) ]);
      };
  };
  var render = function (v) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements_Indexed.textarea([ Data_Function.apply(Halogen_HTML_Events_Indexed_1.onValueInput)(Halogen_HTML_Events.input(Editing.create)) ]), Halogen_HTML_Elements.div_([ renderLanguageSelector(v.value0.language)(Varuna_Ogmarkup.Fr.value), renderLanguageSelector(v.value0.language)(Varuna_Ogmarkup.En.value) ]), Halogen_HTML.slot(RendererSlot.value)(function (v1) {
          return {
              component: Varuna_UI_Renderer.renderer, 
  ...
  var $$eval = function (v) {
      ...
      throw new Error("Failed pattern match at Varuna.UI.Editor line 65, column 1 - line 69, column 12: " + [ v.constructor.name ]);
  };
  ...
  exports["peek"] = peek;
  exports["render"] = render;
  exports["renderLanguageSelector"] = renderLanguageSelector;
  exports["setLanguage"] = setLanguage;
