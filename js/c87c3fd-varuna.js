...
(function(exports) {
  ...
  var reset = Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(Control_Monad_State_Class.get(Control_Monad_State_Trans.monadStateStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity))))(function (v) {
      return Data_Function.apply(Control_Monad_State_Class.put(Control_Monad_State_Trans.monadStateStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity))))(Data_Function.apply(GS.create)((function () {
          var $51 = {};
          for (var $52 in v.value0) {
              if (v.value0.hasOwnProperty($52)) {
                  $51[$52] = v.value0[$52];
              };
          };
          $51.prev = Data_Maybe.Nothing.value;
          return $51;
      })()));
  });
  var raw = function (dictMonoid) {
      return function (str$prime) {
          return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(Control_Monad_State_Class.get(Control_Monad_State_Trans.monadStateStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity))))(function (v) {
              var st$prime = Data_Function.apply(GS.create)((function () {
                  var $56 = {};
                  for (var $57 in v.value0) {
                      if (v.value0.hasOwnProperty($57)) {
                          $56[$57] = v.value0[$57];
                      };
                  };
                  $56.string = Data_Semigroup.append(dictMonoid["__superclass_Data.Semigroup.Semigroup_0"]())(v.value0.string)(str$prime);
                  return $56;
              })());
              return Control_Monad_State_Class.put(Control_Monad_State_Trans.monadStateStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(st$prime);
          });
      };
  };
  ...
  var runGenerator = function (dictMonoid) {
      return function (gen) {
          return function (conf) {
              return ((function () {
                  var $60 = Control_Monad_Reader.runReader(Control_Monad_State_Trans.execStateT(Control_Monad_Reader_Trans.functorReaderT(Data_Identity.functorIdentity))(gen)(initState(dictMonoid)))(conf);
                  return $60.value0;
              })()).string;
          };
      };
  ...
  var atom = function (dictMonoid) {
      return function (text) {
          return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(Control_Monad_State_Class.get(Control_Monad_State_Trans.monadStateStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity))))(function (v) {
              return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(Control_Monad_Reader_Class.ask(Control_Monad_State_Trans.monadReaderStateT(Control_Monad_Reader_Trans.monadReaderReaderT(Data_Identity.monadIdentity))))(function (v1) {
                      ...
                      return Data_Function.apply(Control_Monad_State_Class.put(Control_Monad_State_Trans.monadStateStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity))))(Data_Function.apply(GS.create)((function () {
                          var $70 = (function () {
                              ...
                              for (var $66 in v.value0) {
                                  if (v.value0.hasOwnProperty($66)) {
                                      $65[$66] = v.value0[$66];
                                  };
                              };
                              $65.string = Data_Semigroup.append(dictMonoid["__superclass_Data.Semigroup.Semigroup_0"]())(v.value0.string)(str$prime);
                              return $65;
                          })();
                          var $68 = {};
                          for (var $69 in $70) {
                              if ($70.hasOwnProperty($69)) {
                                  $68[$69] = $70[$69];
                              };
                          };
                          $68.prev = new Data_Maybe.Just(text);
                          return $68;
                      })()));
                  };
                      ...
                      return Data_Function.apply(Control_Monad_State_Class.put(Control_Monad_State_Trans.monadStateStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity))))(Data_Function.apply(GS.create)((function () {
                          var $77 = (function () {
                              ...
                              for (var $73 in v.value0) {
                                  if (v.value0.hasOwnProperty($73)) {
                                      $72[$73] = v.value0[$73];
                                  };
                              };
                              $72.string = Data_Semigroup.append(dictMonoid["__superclass_Data.Semigroup.Semigroup_0"]())(v.value0.string)(Text_Ogmarkup_Private_Typography.normalizeAtom(v1.value0.typography)(text));
                              return $72;
                          })();
                          var $75 = {};
                          for (var $76 in $77) {
                              if ($77.hasOwnProperty($76)) {
                                  $75[$76] = $77[$76];
                              };
                          };
                          $75.prev = new Data_Maybe.Just(text);
                          return $75;
                      })()));
                  };
                  throw new Error("Failed pattern match at Text.Ogmarkup.Private.Generator line 106, column 3 - line 112, column 50: " + [ v.value0.prev.constructor.name ]);
              });
          });
      };
  };
  var atoms = function (dictMonoid) {
      return function (v) {
          if (v instanceof Data_List.Cons) {
              return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(atom(dictMonoid)(v.value0))(function () {
                  return atoms(dictMonoid)(v.value1);
              });
          };
          if (v instanceof Data_List.Nil) {
              return Control_Applicative.pure(Control_Monad_State_Trans.applicativeStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(Data_Unit.unit);
          };
          throw new Error("Failed pattern match at Text.Ogmarkup.Private.Generator line 127, column 1 - line 129, column 12: " + [ v.constructor.name ]);
      };
  };
  var maybeAtom = function (dictMonoid) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Text.Ogmarkup.Private.Generator line 119, column 1 - line 119, column 34: " + [ v.constructor.name ]);
      };
  };
  var apply = function (dictMonoid) {
      return function (temp) {
          return function (gen) {
              return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(Control_Monad_State_Class.get(Control_Monad_State_Trans.monadStateStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity))))(function (v) {
                  return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(Data_Function.apply(Control_Monad_State_Class.put(Control_Monad_State_Trans.monadStateStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity))))(Data_Function.apply(GS.create)((function () {
                      var $86 = {};
                      for (var $87 in v.value0) {
                          if (v.value0.hasOwnProperty($87)) {
                              $86[$87] = v.value0[$87];
                          };
                      };
                      $86.string = Data_Monoid.mempty(dictMonoid);
                      return $86;
                  })())))(function () {
                      return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(gen)(function () {
                          return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(Control_Monad_State_Class.get(Control_Monad_State_Trans.monadStateStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity))))(function (v1) {
                              return Data_Function.apply(Control_Monad_State_Class.put(Control_Monad_State_Trans.monadStateStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity))))(Data_Function.apply(GS.create)((function () {
                                  var $95 = (function () {
                                      var $90 = {};
                                      ...
                                      $90.string = Data_Semigroup.append(dictMonoid["__superclass_Data.Semigroup.Semigroup_0"]())(v.value0.string)(temp(v1.value0.string));
                                      return $90;
                                  })();
                                  var $93 = {};
                                  for (var $94 in $95) {
                                      if ($95.hasOwnProperty($94)) {
                                          $93[$94] = $95[$94];
                                      };
                                  };
                                  $93.prev = v1.value0.prev;
                                  return $93;
                              })()));
                          });
                      });
  ...
  var formats = function (dictMonoid) {
      return function (v) {
          if (v instanceof Data_List.Cons) {
              return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(format(dictMonoid)(v.value0))(function () {
          ...
          throw new Error("Failed pattern match at Text.Ogmarkup.Private.Generator line 162, column 1 - line 164, column 14: " + [ v.constructor.name ]);
      };
  };
  var format = function (dictMonoid) {
      return function (v) {
          ...
          if (v instanceof Text_Ogmarkup_Private_Ast.Quote) {
              return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(Data_Function.apply(atom(dictMonoid))(new Text_Ogmarkup_Private_Ast.Punctuation(Text_Ogmarkup_Private_Ast.OpenQuote.value)))(function () {
                  return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(formats(dictMonoid)(v.value0))(function () {
          ...
          throw new Error("Failed pattern match at Text.Ogmarkup.Private.Generator line 138, column 1 - line 138, column 31: " + [ v.constructor.name ]);
      };
  };
          ...
          return function (end) {
              return function (v) {
                  if (v instanceof Text_Ogmarkup_Private_Ast.Simple) {
                      return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(Control_Monad_Reader_Class.ask(Control_Monad_State_Trans.monadReaderStateT(Control_Monad_Reader_Trans.monadReaderReaderT(Data_Identity.monadIdentity))))(function (v1) {
                          return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(maybeAtom(dictMonoid)(begin))(function () {
                              return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(apply(dictMonoid)(v1.value0.replyTemplate)(formats(dictMonoid)(v.value0)))(function () {
                          ...
                          return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(maybeAtom(dictMonoid)(begin))(function () {
                              return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(apply(dictMonoid)(v1.value0.replyTemplate)(formats(dictMonoid)(v.value0)))(function () {
                                  if (v.value2 instanceof Data_List.Nil) {
                                      return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(maybeAtom(dictMonoid)(end))(function () {
                                          return formats(dictMonoid)(v.value1);
                                      });
                                  };
                                  return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(formats(dictMonoid)(v.value1))(function () {
                                      return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(apply(dictMonoid)(v1.value0.replyTemplate)(formats(dictMonoid)(v.value2)))(function () {
                                          return maybeAtom(dictMonoid)(end);
                                      });
                                  });
                              });
                  ...
                  throw new Error("Failed pattern match at Text.Ogmarkup.Private.Generator line 174, column 1 - line 180, column 16: " + [ begin.constructor.name, end.constructor.name, v.constructor.name ]);
              };
          };
      };
  };
      ...
      return function (p) {
          return function (n) {
              return function (v) {
                  ...
                  throw new Error("Failed pattern match at Text.Ogmarkup.Private.Generator line 203, column 1 - line 213, column 93: " + [ p.constructor.name, n.constructor.name, v.constructor.name ]);
              };
          };
      };
  };
  var paragraph = function (dictMonoid) {
      return function (v) {
                      ...
                      return function (v3) {
                          return function (v4) {
                              if (v4 instanceof Data_List.Cons) {
                                  return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(Data_Function.apply(Control_Applicative.when(Control_Monad_State_Trans.applicativeStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(v2 && isDialogue(v4.value0)))(Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(raw(dictMonoid)(v1))(function () {
                                      return reset;
                                  })))(function () {
                                      return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(component(dictMonoid)(v2)(v3)(v4.value0))(function () {
                              ...
                              throw new Error("Failed pattern match at Text.Ogmarkup.Private.Generator line 252, column 5 - line 256, column 61: " + [ v1.constructor.name, v2.constructor.name, v3.constructor.name, v4.constructor.name ]);
                          };
                      };
                  };
              };
          ...
          throw new Error("Failed pattern match at Text.Ogmarkup.Private.Generator line 233, column 1 - line 257, column 33: " + [ v.constructor.name ]);
      };
  };
  var paragraphs = function (dictMonoid) {
      return function (v) {
          if (v instanceof Data_List.Cons) {
              return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(paragraph(dictMonoid)(v.value0))(function () {
                  return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(reset)(function () {
          ...
          throw new Error("Failed pattern match at Text.Ogmarkup.Private.Generator line 266, column 1 - line 268, column 40: " + [ v.constructor.name ]);
      };
  };
  var section = function (dictMonoid) {
      return function (v) {
          ...
          if (v instanceof Text_Ogmarkup_Private_Ast.Failing) {
              return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(Control_Monad_Reader_Class.ask(Control_Monad_State_Trans.monadReaderStateT(Control_Monad_Reader_Trans.monadReaderReaderT(Data_Identity.monadIdentity))))(function (v1) {
                  return apply(dictMonoid)(function ($175) {
                      return v1.value0.storyTemplate(v1.value0.errorTemplate($175));
                  })(Data_Function.apply(raw(dictMonoid))(v1.value0.typography.wrapWord(v.value0)));
              });
          };
          throw new Error("Failed pattern match at Text.Ogmarkup.Private.Generator line 276, column 1 - line 279, column 55: " + [ v.constructor.name ]);
      };
  };
  var sections = function (dictMonoid) {
      return function (v) {
          if (v instanceof Data_List.Cons) {
              return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(section(dictMonoid)(v.value0))(function () {
          ...
          throw new Error("Failed pattern match at Text.Ogmarkup.Private.Generator line 296, column 1 - line 297, column 36: " + [ v.constructor.name ]);
      };
  };
  var document = function (dictMonoid) {
      return function (d) {
          return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))(Control_Monad_Reader_Class.ask(Control_Monad_State_Trans.monadReaderStateT(Control_Monad_Reader_Trans.monadReaderReaderT(Data_Identity.monadIdentity))))(function (v) {
...
(function(exports) {
  ...
  var Data_Semigroup = PS["Data.Semigroup"];        
  var sput = function (t) {
      return Data_Function.apply(Control_Monad_Trans.lift(Text_Parsing_Parser.monadTransParserT)(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Monad_State_Class.put(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(t));
  };
  var some$prime = function (p) {
      return Data_Functor.map(Text_Parsing_Parser.functorParserT(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity)))(Data_String.fromCharArray)(Data_Array.some(Text_Parsing_Parser.alternativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser.lazyParserT)(p));
  };
  var skip = function (p) {
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(p)(function () {
  ...
  var whiteSpace = Data_Function.apply(skip)(Text_Parsing_Parser_String.satisfy(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(function (c) {
      return c === "\n" || (c === " " || (c === "\t" || c === "\r"));
  }));
  var word = (function () {
      var specChar = Data_String.toCharArray("\"\xab\xbb`+*[]<>|_'\u2019.,;-\u2013\u2014!?:");
      var endOfWord = Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String.eof(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(whiteSpace))(Data_Function.apply(skip)(Text_Parsing_Parser_String.oneOf(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(specChar)));
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_Combinators.notFollowedBy(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(endOfWord))(function () {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity)))(Data_Array.fromFoldable(Data_List_1.foldableList))(Text_Parsing_Parser_Combinators.many1Till(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.anyChar(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_Combinators.lookAhead(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(endOfWord))))(function (v) {
              return Data_Function.apply(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))))(new Text_Ogmarkup_Private_Ast.Word(Data_String.fromCharArray(v)));
          });
      });
  })();
  var sget = Control_Monad_Trans.lift(Text_Parsing_Parser.monadTransParserT)(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(Control_Monad_State_Class.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity)));
  var many$prime = function (p) {
      return Data_Functor.map(Text_Parsing_Parser.functorParserT(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity)))(Data_String.fromCharArray)(Data_Array.many(Text_Parsing_Parser.alternativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser.lazyParserT)(p));
  };
  var mark = (function () {
      var parseMark = function (p) {
          return function (m) {
              return Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(p)(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(m));
          };
      };
      var point = parseMark(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("."))(Text_Ogmarkup_Private_Ast.Point.value);
      var question = parseMark(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("?"))(Text_Ogmarkup_Private_Ast.Question.value);
      var semicolon = parseMark(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(";"))(Text_Ogmarkup_Private_Ast.Semicolon.value);
      var suspensionPoints = parseMark(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String.string(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(".."))(many$prime(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("."))))(Text_Ogmarkup_Private_Ast.SuspensionPoints.value);
      var longDash = parseMark(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String.string(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("\u2014"))(Text_Parsing_Parser_String.string(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("---")))(Text_Ogmarkup_Private_Ast.LongDash.value);
      var hyphen = parseMark(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("-"))(Text_Ogmarkup_Private_Ast.Hyphen.value);
      var exclamation = parseMark(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("!"))(Text_Ogmarkup_Private_Ast.Exclamation.value);
      var dash = parseMark(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String.string(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("\u2013"))(Text_Parsing_Parser_String.string(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("--")))(Text_Ogmarkup_Private_Ast.Dash.value);
      var comma = parseMark(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(","))(Text_Ogmarkup_Private_Ast.Comma.value);
      var colon = parseMark(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(":"))(Text_Ogmarkup_Private_Ast.Colon.value);
      var apostrophe = parseMark(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("'"))(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("\u2019")))(Text_Ogmarkup_Private_Ast.Apostrophe.value);
      return Data_Functor.map(Text_Parsing_Parser.functorParserT(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity)))(Text_Ogmarkup_Private_Ast.Punctuation.create)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(semicolon)(colon))(question))(exclamation))(Text_Parsing_Parser_Combinators["try"](Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(longDash)))(Text_Parsing_Parser_Combinators["try"](Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(dash)))(hyphen))(comma))(apostrophe))(Text_Parsing_Parser_Combinators["try"](Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(suspensionPoints)))(point));
  })();
  var many = function (p) {
      return Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(p)(function (v) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(many(p))(function (v1) {
              return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(new Data_List_1.Cons(v, v1));
          });
      }))(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Data_List_1.Nil.value));
  };
  var some = function (p) {
  ...
  var longword = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("`"))(function () {
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_Combinators.notFollowedBy(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("`")))(function () {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity)))(Data_Array.fromFoldable(Data_List_1.foldableList))(Text_Parsing_Parser_Combinators.manyTill(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.anyChar(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("`"))))(function (v) {
              return Data_Function.apply(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))))(new Text_Ogmarkup_Private_Ast.Word(Data_String.fromCharArray(v)));
          });
      });
  });
  var leaveStrongEmph = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(sget)(function (v) {
      if (v.parseWithStrongEmph) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(sput((function () {
              var $42 = {};
              for (var $43 in v) {
                  if (v.hasOwnProperty($43)) {
                      $42[$43] = v[$43];
      ...
      if (!v.parseWithStrongEmph) {
          return Text_Parsing_Parser.fail(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("cannot leave strong emphasis when you did not enter");
      };
      throw new Error("Failed pattern match at Text.Ogmarkup.Private.Parser line 82, column 22 - line 87, column 1: " + [ v.parseWithStrongEmph.constructor.name ]);
  });
  var leaveQuote = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(sget)(function (v) {
      ...
      if (!v.parseWithinQuote) {
          return Text_Parsing_Parser.fail(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("cannot leave quote when you did not enter");
      };
      throw new Error("Failed pattern match at Text.Ogmarkup.Private.Parser line 99, column 17 - line 104, column 1: " + [ v.parseWithinQuote.constructor.name ]);
  });
  var leaveEmph = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(sget)(function (v) {
      if (v.parseWithEmph) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(sput((function () {
              var $52 = {};
              for (var $53 in v) {
      ...
      if (!v.parseWithEmph) {
          return Text_Parsing_Parser.fail(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("cannot leave emphasis when you did not enter");
      };
      throw new Error("Failed pattern match at Text.Ogmarkup.Private.Parser line 65, column 16 - line 70, column 1: " + [ v.parseWithEmph.constructor.name ]);
  });
  var initParserState = {
      parseWithEmph: false, 
  ...
  var parse = function (ogma) {
      return function (content) {
          return Control_Monad_State.evalState(Text_Parsing_Parser.runParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(new Text_Parsing_Parser.PState({
              input: content, 
              position: Text_Parsing_Parser_Pos.initialPos
          }))(ogma))(initParserState);
      };
  };
  var enterStrongEmph = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(sget)(function (v) {
      if (v.parseWithStrongEmph) {
          return Text_Parsing_Parser.fail(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("guard against nested strong emphasis");
      };
      if (!v.parseWithStrongEmph) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(sput((function () {
              var $57 = {};
              ...
              $57.parseWithStrongEmph = true;
              return $57;
          })()))(function () {
              return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Data_Unit.unit);
          });
      };
      throw new Error("Failed pattern match at Text.Ogmarkup.Private.Parser line 73, column 22 - line 76, column 41: " + [ v.parseWithStrongEmph.constructor.name ]);
  });
  var enterQuote = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(sget)(function (v) {
      if (v.parseWithinQuote) {
          return Text_Parsing_Parser.fail(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("guard against nested quotes");
      };
      if (!v.parseWithinQuote) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(sput((function () {
              var $62 = {};
              ...
              $62.parseWithinQuote = true;
              return $62;
          })()))(function () {
              return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Data_Unit.unit);
          });
      };
      throw new Error("Failed pattern match at Text.Ogmarkup.Private.Parser line 90, column 17 - line 93, column 36: " + [ v.parseWithinQuote.constructor.name ]);
  });
  var enterEmph = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(sget)(function (v) {
      if (v.parseWithEmph) {
          return Text_Parsing_Parser.fail(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("guard against nested emphasis");
      };
      if (!v.parseWithEmph) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Data_Function.apply(sput)((function () {
              var $67 = {};
              for (var $68 in v) {
              ...
              $67.parseWithEmph = true;
              return $67;
          })()))(function () {
              return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Data_Unit.unit);
          });
      };
      throw new Error("Failed pattern match at Text.Ogmarkup.Private.Parser line 56, column 16 - line 59, column 35: " + [ v.parseWithEmph.constructor.name ]);
  });
      ...
      return function (p) {
          var count$prime = function (v) {
              return function (v1) {
                  return function (r) {
                      if (v === 0) {
                          return Data_Function.apply(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))))(Data_List_1.reverse(r));
                      };
                      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(v1)(function (v2) {
          ...
          if (!$74) {
              return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Data_List_1.Nil.value);
          };
          throw new Error("Failed pattern match at Text.Ogmarkup.Private.Parser line 412, column 13 - line 414, column 26: " + [ $74.constructor.name ]);
      };
  };
  var characterName = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("("))(function () {
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_Combinators.notFollowedBy(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(")")))(function () {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity)))(Data_Array.fromFoldable(Data_List_1.foldableList))(Text_Parsing_Parser_Combinators.manyTill(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.anyChar(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(")"))))(function (v) {
              return Data_Function.apply(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))))(Data_String.fromCharArray(v));
          });
      });
  });
  var asideSeparator = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String.string(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("__"))(function () {
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(some(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("_")))(function () {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Data_Unit.unit);
      });
  });
  var endOfParagraph = (function () {
      var betweenTwoSections = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Data_Function.apply(count(2))(Text_Parsing_Parser_Combinators.manyTill(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(whiteSpace)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String.eof(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(skip(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("\n"))))))(function () {
          return Text_Parsing_Parser_String.skipSpaces(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity));
      });
      return Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_Combinators["try"](Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(betweenTwoSections))(asideSeparator))(Text_Parsing_Parser_String.eof(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)));
  })();
  var blank = Data_Function.apply(skip)(Text_Parsing_Parser_Combinators.optional(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_Combinators.notFollowedBy(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(endOfParagraph))(Text_Parsing_Parser_String.skipSpaces(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))));
  var atom = Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(word)(mark))(longword))(blank);
  var raw = Data_Functor.map(Text_Parsing_Parser.functorParserT(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity)))(Text_Ogmarkup_Private_Ast.Raw.create)(some(atom));
  var closeQuote = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("\xbb"))(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("\"")))(function () {
      return blank;
  });
  var openQuote = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("\xab"))(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("\"")))(function () {
      return blank;
  });
  var format = (function () {
      var strongEmph = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("+"))(function () {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(blank)(function () {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(enterStrongEmph)(function () {
                  return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(format)(function (v) {
                      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_Combinators.manyTill(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(format)(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("+"))(blank)))(function (v1) {
                          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(leaveStrongEmph)(function () {
                              return Data_Function.apply(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))))(new Text_Ogmarkup_Private_Ast.StrongEmph(new Data_List_1.Cons(v, v1)));
                          });
                      });
                  });
              });
      ...
      var quote = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(openQuote)(function () {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(enterQuote)(function () {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(format)(function (v) {
                  return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_Combinators.manyTill(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(format)(closeQuote))(function (v1) {
                      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(leaveQuote)(function () {
                          return Data_Function.apply(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))))(new Text_Ogmarkup_Private_Ast.Quote(new Data_List_1.Cons(v, v1)));
                      });
                  });
              });
          });
      });
      var emph = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("*"))(function () {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(blank)(function () {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(enterEmph)(function () {
                  return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(format)(function (v) {
                      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_Combinators.manyTill(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(format)(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("*"))(blank)))(function (v1) {
                          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(leaveEmph)(function () {
                              return Data_Function.apply(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))))(new Text_Ogmarkup_Private_Ast.Emph(new Data_List_1.Cons(v, v1)));
                          });
                      });
                  });
              });
      ...
      return Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(raw)(emph))(strongEmph))(quote);
  })();
  var teller = Data_Functor.map(Text_Parsing_Parser.functorParserT(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity)))(Text_Ogmarkup_Private_Ast.Teller.create)(some(format));
  var reply = function (c) {
      return function (c$prime) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(c))(function () {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(blank)(function () {
                  return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(some(format))(function (v) {
                      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String.oneOf(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))([ "|", c$prime ]))(function (v1) {
                          if (v1 === "|") {
                              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(blank)(function () {
                                  return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(some(format))(function (v2) {
                                      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("|"))(function () {
                                          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(blank)(function () {
                                              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(many(format))(function (v3) {
                                                  return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(c$prime))(function () {
                                                      return Data_Function.apply(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))))(new Text_Ogmarkup_Private_Ast.WithSay(v, v2, v3));
                                                  });
                                              });
                                          });
                                      });
                          ...
                          return Data_Function.apply(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))))(new Text_Ogmarkup_Private_Ast.Simple(v));
                      });
                  });
              });
          });
  ...
  var talk = function (c) {
      return function (c$prime) {
          return function (constructor) {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(reply(c)(c$prime))(function (v) {
                  return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_Combinators.optionMaybe(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(characterName))(function (v1) {
                      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(blank)(function () {
                          return Data_Function.apply(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))))(constructor(v)(v1));
                      });
                  });
              });
          };
  ...
  var dialogue = talk("[")("]")(Text_Ogmarkup_Private_Ast.Dialogue.create);
  var thought = talk("<")(">")(Text_Ogmarkup_Private_Ast.Thought.create);
  var restOfParagraph = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_Combinators.lookAhead(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.anyChar(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))))(function () {
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_Combinators.notFollowedBy(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(endOfParagraph))(function () {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity)))(Data_Array.fromFoldable(Data_List_1.foldableList))(Text_Parsing_Parser_Combinators.manyTill(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.anyChar(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Data_Function.apply(Text_Parsing_Parser_Combinators.lookAhead(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_Combinators["try"](Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(endOfParagraph)))))(function (v) {
              return Data_Function.apply(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))))(Data_String.fromCharArray(v));
          });
      });
  });
  var illformed = Data_Functor.map(Text_Parsing_Parser.functorParserT(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity)))(Text_Ogmarkup_Private_Ast.IllFormed.create)(restOfParagraph);
  var component = Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_Combinators["try"](Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(dialogue)(thought))(teller)))(illformed);
  var paragraph = Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(some(component))(blank);
  var story = Data_Functor.map(Text_Parsing_Parser.functorParserT(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity)))(Text_Ogmarkup_Private_Ast.Story.create)(some(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(paragraph)(Text_Parsing_Parser_String.skipSpaces(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))));
  var aside = (function () {
      var letterChar = Text_Parsing_Parser_String.satisfy(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(function (c) {
          return c >= "a" && c <= "z" || c >= "A" && c <= "Z";
      });
      var asideClass = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(some$prime(letterChar))(function (v) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(asideSeparator)(function () {
      ...
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(asideSeparator)(function () {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_Combinators.optionMaybe(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(asideClass))(function (v) {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String.skipSpaces(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(function () {
                  return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(some(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(paragraph)(Text_Parsing_Parser_String.skipSpaces(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))))(function (v1) {
                      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(asideSeparator)(function () {
                          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_Combinators.manyTill(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.skipSpaces(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(skip(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("\n")))(Text_Parsing_Parser_String.eof(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))))(function () {
                              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String.skipSpaces(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(function () {
                                  return Data_Function.apply(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))))(new Text_Ogmarkup_Private_Ast.Aside(v, v1));
                              });
                          });
                      });
                  });
  ...
  var section = Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(aside)(story);
  var document = (function () {
      var recover = function (ast) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity)))(Data_Array.fromFoldable(Data_List_1.foldableList))(Text_Parsing_Parser_Combinators.many1Till(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.anyChar(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String["char"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("\n"))))(function (v) {
              return Data_Function.apply(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))))(Data_Semigroup.append(Data_List_1.semigroupList)(ast)(new Data_List_1.Cons(Data_Function.apply(Text_Ogmarkup_Private_Ast.Failing.create)(Data_String.fromCharArray(v)), Data_List_1.Nil.value)));
          });
      };
      var doc = function (ast) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String.skipSpaces(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(function () {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(many(Text_Parsing_Parser_Combinators["try"](Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(section)))(function (v) {
                  var ast$prime = Data_Semigroup.append(Data_List_1.semigroupList)(ast)(v);
                  return Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String.eof(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(ast$prime)))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(recover(ast$prime))(doc));
              });
          });
      };
...
(function(exports) {
  ...
  var ogmarkup = function (dictMonoid) {
      return function (input) {
          return function (conf) {
              var $1 = Text_Ogmarkup_Private_Parser.parse(Text_Ogmarkup_Private_Parser.document)(input);
              if ($1 instanceof Data_Either.Right) {
                  return Text_Ogmarkup_Private_Generator.runGenerator(dictMonoid)(Text_Ogmarkup_Private_Generator.document(dictMonoid)($1.value0))(conf);
              };
              if ($1 instanceof Data_Either.Left) {
                  return Data_Monoid.mempty(dictMonoid);
              };
              throw new Error("Failed pattern match at Text.Ogmarkup line 44, column 23 - line 46, column 38: " + [ $1.constructor.name ]);
          };
      };
  };
...
(function(exports) {
  ...
  var printHtmlSpace = function (v) {
      ...
      throw new Error("Failed pattern match at Varuna.Ogmarkup line 60, column 1 - line 61, column 1: " + [ v.constructor.name ]);
  };
  ...
  var lang2typo = function (v) {
      ...
      throw new Error("Failed pattern match at Varuna.Ogmarkup line 34, column 1 - line 34, column 18: " + [ v.constructor.name ]);
  };
...
(function(exports) {
  ...
  var setOgmarkup = function (txt) {
      return function (v) {
          return Data_Function.apply(State.create)((function () {
              var $7 = {};
              for (var $8 in v.value0) {
                  if (v.value0.hasOwnProperty($8)) {
                      $7[$8] = v.value0[$8];
                  };
              };
              $7.ogmarkup = txt;
  ...
  var render = function (v) {
      var renderFrench = function (l) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements_Indexed.input([ Data_Function.apply(Halogen_HTML_Properties_Indexed.checked)(Data_Eq.eq(Varuna_Ogmarkup.eqLang)(l)(Varuna_Ogmarkup.Fr.value)), Halogen_HTML_Properties_Indexed.inputType(Halogen_HTML_Properties_Indexed.InputRadio.value), Data_Function.apply(function ($27) {
              return Halogen_HTML_Events_Indexed.onClick(Halogen_HTML_Events.input_($27));
          })(SetLang.create(Varuna_Ogmarkup.Fr.value)) ]), Halogen_HTML.text("French") ]);
      };
      var renderEnglish = function (l) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements_Indexed.input([ Data_Function.apply(Halogen_HTML_Properties_Indexed.checked)(Data_Eq.eq(Varuna_Ogmarkup.eqLang)(l)(Varuna_Ogmarkup.En.value)), Halogen_HTML_Properties_Indexed.inputType(Halogen_HTML_Properties_Indexed.InputRadio.value), Data_Function.apply(function ($28) {
              return Halogen_HTML_Events_Indexed.onClick(Halogen_HTML_Events.input_($28));
          })(SetLang.create(Varuna_Ogmarkup.En.value)) ]), Halogen_HTML.text("English") ]);
      };
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements_Indexed.textarea([ Halogen_HTML_Events_Indexed.onValueInput(Halogen_HTML_Events.input(UpdateText.create)), Halogen_HTML_Properties_Indexed.value(v.value0.ogmarkup) ]), Halogen_HTML_Elements_Indexed.form([  ])([ renderFrench(v.value0.language), renderEnglish(v.value0.language) ]), Data_Function.apply(Halogen_HTML_Elements.div_)(Text_Ogmarkup.ogmarkup(Data_Monoid.monoidArray)(v.value0.ogmarkup)(Varuna_Ogmarkup.conf(v.value0.language))) ]);
  };
  ...
  var $$eval = function (v) {
      ...
      throw new Error("Failed pattern match at Varuna.Component.Editor line 75, column 1 - line 77, column 12: " + [ v.constructor.name ]);
  };
