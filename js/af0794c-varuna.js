...
(function(exports) {
  ...
  var render = function (clss) {
      return function (v) {
          return Halogen_HTML_Elements_Indexed.div([ Halogen_HTML_Properties_Indexed.classes(clss) ])(v.value0.preview);
      };
  };
  var init = new State({
      preview: [  ], 
  ...
  var $$eval = function (v) {
                  ...
                  if (v1 instanceof Free) {
                      return Control_Bind.bind(Control_Monad_Free.freeBind)(Data_Function.apply(Halogen_Query.modify)(setQueue(Busy.value)))(function () {
                          return Data_Function.apply(function ($48) {
                              return Varuna_Component_Utils.raise(Control_Monad_Aff_Free.affableAff)(Control_Monad_Aff.functorAff)(Halogen_Query.action($48));
                          })(Render.create(v.value0)(v.value1));
                      });
                  };
                  return Data_Function.apply(function ($49) {
                      return Halogen_Query.modify(setQueue($49));
      ...
      if (v instanceof Render) {
          ...
          return Control_Bind.bind(Control_Monad_Free.freeBind)(Data_Function.apply(function ($50) {
              return Control_Monad_Aff_Free.fromAff(Control_Monad_Aff_Free.affableFree(Halogen_Query_HalogenF.affableHalogenF(Control_Monad_Aff_Free.affableAff)))(Control_Monad_Aff.attempt($50));
          })(renderOgmarkup(v.value1)(v.value0)))(function (v1) {
              return Control_Bind.bind(Control_Monad_Free.freeBind)((function () {
                  if (v1 instanceof Data_Either.Right) {
                      return Control_Bind.bind(Control_Monad_Free.freeBind)(Data_Function.apply(function ($51) {
                          return Varuna_Component_Utils.raise(Control_Monad_Aff_Free.affableAff)(Control_Monad_Aff.functorAff)(Halogen_Query.action($51));
                  ...
                  throw new Error("Failed pattern match at Varuna.UI.Renderer line 77, column 3 - line 79, column 37: " + [ v1.constructor.name ]);
              })())(function () {
                  return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(v.value2);
              });
          });
          ...
          return Control_Bind.bind(Control_Monad_Free.freeBind)(Halogen_Query.gets(getQueue))(function (v1) {
              return Control_Bind.bind(Control_Monad_Free.freeBind)((function () {
                  if (v1 instanceof Pending) {
                      return Control_Bind.bind(Control_Monad_Free.freeBind)(Data_Function.apply(Halogen_Query.modify)(setQueue(Busy.value)))(function () {
                          return Data_Function.apply(function ($52) {
                              return Varuna_Component_Utils.raise(Control_Monad_Aff_Free.affableAff)(Control_Monad_Aff.functorAff)(Halogen_Query.action($52));
      ...
      throw new Error("Failed pattern match at Varuna.UI.Renderer line 68, column 1 - line 73, column 12: " + [ v.constructor.name ]);
  };
