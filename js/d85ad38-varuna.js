...
(function(exports) {
  ...
  var Halogen_HTML_Core = PS["Halogen.HTML.Core"];
  var row = Halogen_HTML_Core.className("row");                       
  var container = Halogen_HTML_Core.className("container");
  var colLg6 = Halogen_HTML_Core.className("col-lg-6");
...
(function(exports) {
  ...
  var loading = function (v) {
      return function (content) {
          if (v) {
              return Data_Array.cons(Halogen_HTML_Elements_Indexed.div([ Halogen_HTML_Properties_Indexed.classes([ Halogen_HTML_Core.className("loader") ]) ])([  ]))(content);
          };
          if (!v) {
              return Data_Array.cons(Halogen_HTML_Elements_Indexed.div([ Halogen_HTML_Properties_Indexed.classes([ Halogen_HTML_Core.className("loaded") ]) ])([  ]))(content);
          };
          throw new Error("Failed pattern match at Varuna.UI.HTML.Loading line 13, column 1 - line 14, column 42: " + [ v.constructor.name, content.constructor.name ]);
      };
  };
  exports["loading"] = loading;
})(PS["Varuna.UI.HTML.Loading"] = PS["Varuna.UI.HTML.Loading"] || {});
(function(exports) {
  // Generated by psc version 0.9.3
  "use strict";
  var Prelude = PS["Prelude"];
  ...
  var Text_Ogmarkup = PS["Text.Ogmarkup"];
  var Varuna_UI_HTML_Loading = PS["Varuna.UI.HTML.Loading"];
  var Data_Function = PS["Data.Function"];
  var Halogen_HTML_Elements_Indexed = PS["Halogen.HTML.Elements.Indexed"];
  var Control_Bind = PS["Control.Bind"];
  var Control_Monad_Free = PS["Control.Monad.Free"];
  ...
  var Ask = (function () {
      function Ask(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      Ask.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new Ask(value0, value1, value2);
              };
          };
      };
      return Ask;
  ...
  var Render = (function () {
      function Render(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      Render.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new Render(value0, value1, value2);
              };
          };
      };
      return Render;
  ...
  var previewing = function (v) {
      if (v instanceof Free) {
          return false;
      };
      return true;
  };
  var render = function (clss) {
      return function (v) {
          return Data_Function.apply(Halogen_HTML_Elements_Indexed.div([ Halogen_HTML_Properties_Indexed.classes(clss) ]))(Varuna_UI_HTML_Loading.loading(previewing(v.value0.queue))(v.value0.preview));
      };
  };
  var init = new State({
      preview: [  ], 
  ...
  var getQueue = function (v) {
      return v.value0.queue;
  };
  var $$eval = function (v) {
      if (v instanceof Ask) {
          return Control_Bind.bind(Control_Monad_Free.freeBind)(Halogen_Query.gets(getQueue))(function (v1) {
              return Control_Bind.bind(Control_Monad_Free.freeBind)((function () {
                  if (v1 instanceof Free) {
                      return Control_Bind.bind(Control_Monad_Free.freeBind)(Data_Function.apply(Halogen_Query.modify)(setQueue(Busy.value)))(function () {
                          return Data_Function.apply(function ($50) {
                              return Varuna_Component_Utils.raise(Control_Monad_Aff_Free.affableAff)(Control_Monad_Aff.functorAff)(Halogen_Query.action($50));
                          })(Render.create(v.value0)(v.value1));
                      });
                  };
                  return Data_Function.apply(function ($51) {
                      return Halogen_Query.modify(setQueue($51));
                  })(new Pending(v.value0, v.value1));
              })())(function () {
      ...
      if (v instanceof Render) {
          var renderOgmarkup = function (txt1) {
              return function (l1) {
                  return Text_Ogmarkup.ogmarkup(Data_Monoid.monoidArray)(txt1)(Varuna_Ogmarkup.conf(l1));
              };
          };
          return Control_Bind.bind(Control_Monad_Free.freeBind)(Data_Function.apply(function ($52) {
              return Control_Monad_Aff_Free.fromAff(Control_Monad_Aff_Free.affableFree(Halogen_Query_HalogenF.affableHalogenF(Control_Monad_Aff_Free.affableAff)))(Control_Monad_Aff.attempt($52));
          })(renderOgmarkup(v.value1)(v.value0)))(function (v1) {
              return Control_Bind.bind(Control_Monad_Free.freeBind)((function () {
                  if (v1 instanceof Data_Either.Right) {
                      return Control_Bind.bind(Control_Monad_Free.freeBind)(Data_Function.apply(function ($53) {
                          return Varuna_Component_Utils.raise(Control_Monad_Aff_Free.affableAff)(Control_Monad_Aff.functorAff)(Halogen_Query.action($53));
                      })(Display.create(v1.value0)))(function () {
                          return Data_Function.apply(Varuna_Component_Utils.raise(Control_Monad_Aff_Free.affableAff)(Control_Monad_Aff.functorAff))(Halogen_Query.action(Check.create));
                      });
                  };
                  if (v1 instanceof Data_Either.Left) {
                      return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(Data_Unit.unit);
                  };
                  throw new Error("Failed pattern match at Varuna.UI.Renderer line 81, column 3 - line 83, column 37: " + [ v1.constructor.name ]);
              })())(function () {
                  return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(v.value2);
              });
          });
          ...
          return Control_Bind.bind(Control_Monad_Free.freeBind)(Halogen_Query.gets(getQueue))(function (v1) {
              return Control_Bind.bind(Control_Monad_Free.freeBind)((function () {
                  if (v1 instanceof Pending) {
                      return Control_Bind.bind(Control_Monad_Free.freeBind)(Data_Function.apply(Halogen_Query.modify)(setQueue(Busy.value)))(function () {
                          return Data_Function.apply(function ($54) {
                              return Varuna_Component_Utils.raise(Control_Monad_Aff_Free.affableAff)(Control_Monad_Aff.functorAff)(Halogen_Query.action($54));
                          })(Render.create(v1.value0)(v1.value1));
                      });
                  };
                  return Data_Function.apply(Halogen_Query.modify)(setQueue(Free.value));
              })())(function () {
                  return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(v.value0);
              });
          });
      };
      throw new Error("Failed pattern match at Varuna.UI.Renderer line 72, column 1 - line 77, column 12: " + [ v.constructor.name ]);
  };
  var renderer = function (clss) {
  ...
  exports["init"] = init;
  exports["previewing"] = previewing;
  exports["render"] = render;
  exports["renderer"] = renderer;
  exports["setPreview"] = setPreview;
  exports["setQueue"] = setQueue;
})(PS["Varuna.UI.Renderer"] = PS["Varuna.UI.Renderer"] || {});
(function(exports) {
  // Generated by psc version 0.9.3
  "use strict";
  var Prelude = PS["Prelude"];
  ...
  var Halogen_HTML_Core = PS["Halogen.HTML.Core"];
  var Halogen_HTML_Indexed = PS["Halogen.HTML.Indexed"];
  var Halogen_HTML_Events_Indexed_1 = PS["Halogen.HTML.Events.Indexed"];
  var Halogen_HTML_Properties_Indexed = PS["Halogen.HTML.Properties.Indexed"];
  var Halogen_HTML_Events_Indexed_1 = PS["Halogen.HTML.Events.Indexed"];
  var Halogen_Themes_Bootstrap3 = PS["Halogen.Themes.Bootstrap3"];
  var Varuna_UI_Renderer = PS["Varuna.UI.Renderer"];
  var Varuna_Ogmarkup = PS["Varuna.Ogmarkup"];
  var Data_Eq = PS["Data.Eq"];
  var Data_Ord = PS["Data.Ord"];
  var Data_Ordering = PS["Data.Ordering"];
  ...
  var InnerState = (function () {
      function InnerState(value0) {
          this.value0 = value0;
      };
      InnerState.create = function (value0) {
          return new InnerState(value0);
      };
      return InnerState;
  })();
  ...
  var SetLanguage = (function () {
      function SetLanguage(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetLanguage.create = function (value0) {
          return function (value1) {
              return new SetLanguage(value0, value1);
          };
      };
      return SetLanguage;
  })();
  var RendererSlot = (function () {
      function RendererSlot() {

      };
      RendererSlot.value = new RendererSlot();
      return RendererSlot;
  })();
  var setOgmarkup = function (txt) {
      return function (v) {
          return Data_Function.apply(InnerState.create)((function () {
              var $16 = {};
  ...
  var render = function (v) {
      var renderer = function (slot) {
          return Halogen_HTML.slot(slot)(function (v1) {
              return {
                  component: Varuna_UI_Renderer.renderer([ Halogen_Themes_Bootstrap3.colLg6, Halogen_HTML_Core.className("varuna-renderer"), Halogen_HTML_Core.className("fill") ]), 
                  initialState: Varuna_UI_Renderer.init
              };
          });
      };
      var langSelector = function (current) {
          return function (option) {
              return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements_Indexed.input([ Data_Function.apply(Halogen_HTML_Properties_Indexed.checked)(Data_Eq.eq(Varuna_Ogmarkup.eqLang)(current)(option)), Halogen_HTML_Properties_Indexed.inputType(Halogen_HTML_Properties_Indexed.InputRadio.value), Data_Function.apply(function ($45) {
                  return Halogen_HTML_Events_Indexed_1.onClick(Halogen_HTML_Events.input_($45));
              })(SetLanguage.create(option)) ]), Data_Function.apply(Halogen_HTML.text)((function () {
                  if (option instanceof Varuna_Ogmarkup.Fr) {
                      return "French";
                  };
                  if (option instanceof Varuna_Ogmarkup.En) {
                      return "English";
                  };
                  throw new Error("Failed pattern match at Varuna.UI.Editor line 110, column 16 - line 112, column 14: " + [ option.constructor.name ]);
              })()) ]);
          };
      };
      var langSelection = function (current) {
          return Halogen_HTML_Elements_Indexed.div([  ])([ langSelector(current)(Varuna_Ogmarkup.Fr.value), langSelector(current)(Varuna_Ogmarkup.En.value) ]);
      };
      var menu = Halogen_HTML_Elements_Indexed.div([ Halogen_HTML_Properties_Indexed.classes([ Halogen_HTML_Core.className("varuna-editor-menu") ]) ])([ Halogen_HTML_Elements.h1_([ Halogen_HTML.text("Typography") ]), langSelection(v.value0.language) ]);
      var editing = Halogen_HTML_Elements_Indexed.textarea([ Data_Function.apply(Halogen_HTML_Events_Indexed_1.onValueInput)(Halogen_HTML_Events.input(Editing.create)), Halogen_HTML_Properties_Indexed.classes([ Halogen_Themes_Bootstrap3.colLg6, Halogen_HTML_Core.className("fill"), Halogen_HTML_Core.className("varuna-textarea") ]) ]);
      var body = Halogen_HTML_Elements_Indexed.div([ Halogen_HTML_Properties_Indexed.classes([ Halogen_Themes_Bootstrap3.container, Halogen_HTML_Core.className("fill") ]) ])([ Halogen_HTML_Elements_Indexed.div([ Halogen_HTML_Properties_Indexed.classes([ Halogen_Themes_Bootstrap3.row, Halogen_HTML_Core.className("editor-head") ]) ])([ Halogen_HTML_Elements_Indexed.div([ Halogen_HTML_Properties_Indexed.classes([ Halogen_Themes_Bootstrap3.colLg6 ]) ])([ Halogen_HTML.text("Markup") ]), Halogen_HTML_Elements_Indexed.div([ Halogen_HTML_Properties_Indexed.classes([ Halogen_Themes_Bootstrap3.colLg6 ]) ])([ Halogen_HTML.text("Preview") ]) ]), Halogen_HTML_Elements_Indexed.div([ Halogen_HTML_Properties_Indexed.classes([ Halogen_Themes_Bootstrap3.row, Halogen_HTML_Core.className("editor-main") ]) ])([ editing, renderer(RendererSlot.value) ]) ]);
      return Halogen_HTML_Elements_Indexed.div([ Halogen_HTML_Properties_Indexed.classes([ Halogen_HTML_Core.className("varuna-editor"), Halogen_HTML_Core.className("fill") ]) ])([ menu, body ]);
  };
  var peek = function (v) {
      return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(Data_Unit.unit);
  };
  var init = Data_Function.apply(Halogen_Component.parentState)(new InnerState({
      ogmarkup: "", 
      language: Varuna_Ogmarkup.En.value
  }));
  var getOgmarkup = function (v) {
      return v.value0.ogmarkup;
  };
  var getLanguage = function (v) {
      return v.value0.language;
  };
  var eqEditorSlot = new Data_Eq.Eq(function (x) {
      return function (y) {
          return true;
      };
  });
  var ordEditorSlot = new Data_Ord.Ord(function () {
      return eqEditorSlot;
  }, function (x) {
      return function (y) {
          return Data_Ordering.EQ.value;
  ...
  var $$eval = function (v) {
      if (v instanceof Editing) {
          return Control_Bind.bind(Control_Monad_Free.freeBind)(Data_Function.apply(Halogen_Query.modify)(setOgmarkup(v.value0)))(function () {
              return Control_Bind.bind(Control_Monad_Free.freeBind)(Halogen_Query.gets(getLanguage))(function (v1) {
                  return Control_Bind.bind(Control_Monad_Free.freeBind)(Halogen_Component.query(Control_Monad_Aff.functorAff)(ordEditorSlot)(RendererSlot.value)(Data_Function.apply(Halogen_Query.action)(Varuna_UI_Renderer.Ask.create(v1)(v.value0))))(function () {
                      return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(v.value1);
                  });
              });
          });
      };
      if (v instanceof SetLanguage) {
          return Control_Bind.bind(Control_Monad_Free.freeBind)(Data_Function.apply(Halogen_Query.modify)(setLanguage(v.value0)))(function () {
              return Control_Bind.bind(Control_Monad_Free.freeBind)(Halogen_Query.gets(getOgmarkup))(function (v1) {
                  return Control_Bind.bind(Control_Monad_Free.freeBind)(Halogen_Component.query(Control_Monad_Aff.functorAff)(ordEditorSlot)(RendererSlot.value)(Data_Function.apply(Halogen_Query.action)(Varuna_UI_Renderer.Ask.create(v.value0)(v1))))(function () {
                      return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(v.value1);
                  });
              });
          });
      };
      throw new Error("Failed pattern match at Varuna.UI.Editor line 120, column 1 - line 124, column 12: " + [ v.constructor.name ]);
  };
  var editor = Halogen_Component.parentComponent(Control_Monad_Aff.functorAff)(ordEditorSlot)({
      render: render, 
      "eval": $$eval, 
      peek: new Data_Maybe.Just(peek)
  });
  exports["RendererSlot"] = RendererSlot;
  exports["Editing"] = Editing;
  exports["SetLanguage"] = SetLanguage;
  exports["InnerState"] = InnerState;
  ...
  exports["eqEditorSlot"] = eqEditorSlot;
  exports["ordEditorSlot"] = ordEditorSlot;
})(PS["Varuna.UI.Editor"] = PS["Varuna.UI.Editor"] || {});
(function(exports) {
  // Generated by psc version 0.9.3
  "use strict";
  var Prelude = PS["Prelude"];
  ...
  var Varuna_UI_Editor = PS["Varuna.UI.Editor"];
  var Data_Function = PS["Data.Function"];
  var Control_Bind = PS["Control.Bind"];
  var Control_Monad_Aff = PS["Control.Monad.Aff"];
  var Data_Functor = PS["Data.Functor"];
  ...
  var main = Data_Function.apply(Halogen_Util.runHalogenAff)(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Util.awaitBody)(function (v) {
      return Data_Function.apply(Data_Functor["void"](Control_Monad_Aff.functorAff))(Halogen_Driver.runUI(Varuna_UI_Editor.editor)(Varuna_UI_Editor.init)(v));
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
